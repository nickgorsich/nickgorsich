...
def Wordle():
    choice = random.randint(0, 1859)
    answer = (wordList[choice]).upper()
        ...
        if a == list("quit"):
            ...
            if count == 5:
                ...
                with open('leaderboard.txt', 'r') as leaderboard:
                    ...
                    print(style.MAGENTA + f"      -- Leaderboard --\n{board}" + style.RESET) # leaderboard print statement
            ...
            attempts -= 1
            print(style.BLACK + "Not a word or not 5 letters"+ style.RESET)
